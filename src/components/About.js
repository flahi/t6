        ...
        <div id="about-section" className="container text-start px-5 text-center text-dark" style={{ marginTop: "100px", marginBottom: "100px" }}>
            <div className="row">
                <div className="col-md-6 d-flex align-items-center text-start">
                    <div >
                        <TypeAnimation
                            sequence={['Welcome!\n I am Faheema Kattakath Sanil', 1000, "",]}
                            speed={50}
                            style={{ whiteSpace: 'pre-line', fontSize: '3em', fontWeight: 'bolder'}}
                            repeat={Infinity}
                        /><br /><br /><br />
                        <p>I'm a third year Computer Science and Engineering undergraduate, I am deeply passionate about Web development, data Science, ML and Robotics.</p>
                ...
                <div className="col-md-4">
                    <img src="https://img.freepik.com/free-photo/stunning-square-portrait-adorable-cute-cat_181624-37290.jpg" alt="person image" className="img-round img-fluid border-dark" />
                </div>
            </div>
        </div>
    );
